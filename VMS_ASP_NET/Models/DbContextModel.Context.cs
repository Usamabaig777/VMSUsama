...
namespace VMS_ASP_NET.Models
{
    ...
    public partial class VMSEntities : DbContext
    {
        ...
        public virtual DbSet<IncidentReportAttachment> IncidentReportAttachments { get; set; }
        ...
        public virtual DbSet<TrailerAttachment> TrailerAttachments { get; set; }
        ...
        public virtual DbSet<VisitMain> VisitMains { get; set; }
        public virtual DbSet<Visitor> Visitors { get; set; }
        public virtual DbSet<VisitorNotification> VisitorNotifications { get; set; }
        public virtual DbSet<VisitorStatu> VisitorStatus { get; set; }
        public virtual DbSet<VisitorType> VisitorTypes { get; set; }
        public virtual DbSet<VisitorVehicle> VisitorVehicles { get; set; }
        public virtual DbSet<VMSErrorLog> VMSErrorLogs { get; set; }
        public virtual DbSet<Environment> Environments { get; set; }
        public virtual DbSet<IncidentReportType> IncidentReportTypes { get; set; }
    
        [DbFunction("VMSEntities", "Split")]
        public virtual IQueryable<Split_Result> Split(string inputString, string delimiter)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<Split_Result>("[VMSEntities].[Split](@InputString, @Delimiter)", inputStringParameter, delimiterParameter);
        }
        ...
        public virtual ObjectResult<vms_DotNet_GetVisitorDetailByVisitDetailID_Result> vms_DotNet_GetVisitorDetailByVisitDetailID(Nullable<int> visitDetailID)
        {
            var visitDetailIDParameter = visitDetailID.HasValue ?
                new ObjectParameter("VisitDetailID", visitDetailID) :
                new ObjectParameter("VisitDetailID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<vms_DotNet_GetVisitorDetailByVisitDetailID_Result>("vms_DotNet_GetVisitorDetailByVisitDetailID", visitDetailIDParameter);
        }
    
        public virtual ObjectResult<vms_GetAllCheckedInVisitsDotNet_Result> vms_GetAllCheckedInVisitsDotNet(Nullable<int> siteID)
        {
            var siteIDParameter = siteID.HasValue ?
                new ObjectParameter("SiteID", siteID) :
                new ObjectParameter("SiteID", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<vms_GetAllCheckedInVisitsDotNet_Result>("vms_GetAllCheckedInVisitsDotNet", siteIDParameter);
        }
    
        public virtual ObjectResult<VMS_GetAllNotifications_Result> VMS_GetAllNotifications(Nullable<int> siteID, Nullable<int> userID)
        {
            var siteIDParameter = siteID.HasValue ?
                new ObjectParameter("SiteID", siteID) :
                new ObjectParameter("SiteID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<VMS_GetAllNotifications_Result>("VMS_GetAllNotifications", siteIDParameter, userIDParameter);
        }
    
        public virtual ObjectResult<VMS_GetAllNotificationsDotNet_Result> VMS_GetAllNotificationsDotNet(Nullable<int> siteID, Nullable<int> userID)
        {
            var siteIDParameter = siteID.HasValue ?
                new ObjectParameter("SiteID", siteID) :
                new ObjectParameter("SiteID", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<VMS_GetAllNotificationsDotNet_Result>("VMS_GetAllNotificationsDotNet", siteIDParameter, userIDParameter);
        }
    }
}
